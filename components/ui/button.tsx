...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium tracking-wide transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 disabled:pointer-events-none disabled:opacity-60 disabled:hover:translate-y-0 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-forest text-cream shadow-sm hover:bg-forest-dark",
        gold: "bg-gold text-forest-dark shadow-sm hover:bg-gold-dark hover:text-cream",
        outline:
          "border border-forest/30 bg-transparent text-forest hover:bg-forest hover:text-cream",
        outlineLight:
          "border border-cream/60 bg-transparent text-cream hover:bg-cream hover:text-forest",
