...
export function ServiceCard({
  ...
  return (
    <div className="group flex h-full flex-col rounded-2xl border border-stone-200/60 bg-white p-8 shadow-sm transition-transform duration-300 hover:-translate-y-1">
      {featured ? (
      ...
      <h3
        className={cn(
          "mt-6 font-serif font-semibold text-forest",
