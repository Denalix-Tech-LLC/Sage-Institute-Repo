...
/**
 * Brand social marks as inline SVGs.
 * (lucide-react removed brand/logo icons, so we ship our own here.)
 * They inherit color via `currentColor` and size via Tailwind classes.
 */
